...
describe('GoalService', () => {
  ...
  describe('createGoal - Story 4.2 Cenário: Criar primeira meta', () => {
    ...
    it('deve lançar erro quando atingir limite de 5 metas ativas', async () => {
      ...
      await expect(
        goalService.createGoal(testUserId, goalData)
      ).rejects.toThrow('Você já atingiu o limite de 5 metas ativas');
    });
  ...
  describe('getGoalById', () => {
    ...
    it('deve lançar erro quando meta não pertence ao usuário', async () => {
      ...
      ).rejects.toThrow('Você não tem permissão para acessar esta meta');
    });
  });
  ...
  describe('deleteGoal - Soft Delete', () => {
    ...
    it('deve lançar erro quando meta não pertence ao usuário', async () => {
      ...
      ).rejects.toThrow('Você não tem permissão para deletar esta meta');
    });
  });
