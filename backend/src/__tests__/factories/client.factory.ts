...
export function createClient(
  overrides: Partial<Prisma.ClientCreateInput> = {}
 ...
 */
export function createInactiveClient(
  overrides: Partial<Prisma.ClientCreateInput> = {}
): Prisma.ClientCreateInput {
  return createClient({
