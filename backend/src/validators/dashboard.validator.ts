...
export const dashboardChartQuerySchema = z
  .object({
    start_date: z
      .string()
      .datetime()
    ...
    end_date: z
      ...
      .transform((val) => new Date(val))
      .optional(),
    period: z.enum(['7d', '30d', '90d', '1y', 'custom']).optional().default('30d'),
  })
  .refine(
    (data) => {
...
export const dashboardActivitiesQuerySchema = z.object({
  limit: z
    ...
    .optional()
    .default('10'),
  type: z.enum(['sale', 'payment', 'client', 'ad', 'all']).optional().default('all'),
  days: z
    .string()
...
export type DashboardMetricsWithComparisonsResponse = z.infer<
  typeof dashboardMetricsWithComparisonsResponseSchema
>
