...
router.post(
  '/subscriptions',
  authenticate,
  pagBankController.createSubscription.bind(pagBankController)
)
...
router.get(
  '/subscriptions',
  authenticate,
  pagBankController.getSubscriptions.bind(pagBankController)
)
...
router.get(
  '/subscriptions/:id',
  authenticate,
  pagBankController.getSubscription.bind(pagBankController)
)
...
router.delete(
  ...
  authenticate,
  pagBankController.cancelSubscription.bind(pagBankController)
)
