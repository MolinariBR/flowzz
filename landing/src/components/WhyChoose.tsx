  ...
  const reasons = [
    {
      ...
      description:
        'A Flowzz foi criada para maximizar seus resultados através de análises precisas e automação inteligente.',
    },
    {
      icon: TrendingUp,
      title: 'Profissionalização',
      description:
        'Transforme sua operação com relatórios profissionais e controle total sobre sua contabilidade.',
    },
    {
      icon: Shield,
      title: 'Crescimento Seguro',
      description:
        'Prepare seu negócio para escalar com dados confiáveis e projeções precisas de fluxo de caixa.',
    },
  ]
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-light text-white mb-6 tracking-tight">
            Porque você escolhe a <span className="font-medium text-indigo-400">Flowzz</span>
          </h2>
