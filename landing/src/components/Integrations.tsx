...
import {MessageCircleDashed as MessageCircle, Facebook, Smartphone, CreditCard, BarChart3, Zap} from 'lucide-react'
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-gray-400 max-w-2xl mx-auto font-light">
            Conecte todas as suas ferramentas favoritas em um só lugar. 
            Integrações simples e diretas para otimizar seu trabalho.
          </p>
        </motion.div>
