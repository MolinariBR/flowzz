  ...
  const benefits = [
    {
      ...
      description:
        'Visualize seus dados financeiros em tempo real com gráficos intuitivos e métricas que realmente importam.',
    ...
    },
    {
      ...
      description:
        'Automatize cobranças, relatórios e reconciliações. Foque no que realmente gera valor para seu negócio.',
    ...
    },
    {
      ...
      description:
        'Proteção de dados com criptografia de nível bancário e conformidade com as principais regulamentações.',
    ...
    },
    {
      ...
      description:
        'Conecte-se com suas ferramentas favoritas em minutos. APIs robustas e integrações nativas.',
    ...
    },
    {
      ...
      description:
        'Elimine erros humanos com validações automáticas e reconciliação inteligente de transações.',
    ...
    },
    {
      ...
      description:
        'Tome decisões baseadas em dados reais e projete o futuro do seu negócio com confiança.',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto font-light leading-relaxed">
            Descubra como a Flowzz pode revolucionar a forma como você gerencia suas finanças, com
            tecnologia de ponta e simplicidade incomparável.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => (
            ...
            >
              {/* Background Glow */}
              <div
                className={`absolute inset-0 bg-gradient-to-r ${benefit.gradient} opacity-0 group-hover:opacity-20 rounded-2xl blur-xl transition-opacity duration-500`}
              ></div>
              ...
              <div className="relative bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700 rounded-2xl p-8 h-full hover:border-gray-600 transition-all duration-300">
                {/* Icon */}
                <div
                  className={`w-14 h-14 bg-gradient-to-r ${benefit.gradient} rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}
                >
