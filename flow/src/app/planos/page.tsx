  ...
  const plans = [
    {
      ...
      limitations: ['Sem relatórios personalizados', 'Sem API access', 'Sem suporte prioritário'],
      popular: false,
    },
    {
      id: 'pro',
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-xl p-8 border border-slate-200">
        <h2 className="text-2xl font-bold text-slate-900 mb-6">Comparação Detalhada</h2>
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr className="border-b border-slate-200">
                <th className="text-left py-4 px-4 font-semibold text-slate-900">Funcionalidade</th>
