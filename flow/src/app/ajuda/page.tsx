  ...
  const tutorials = [
    {
      ...
      description: 'Aprenda a configurar sua conta e conectar suas primeiras integrações',
      duration: '5 min',
      type: 'video',
      thumbnail:
    ...
    },
    {
      ...
      description: 'Passo a passo para conectar e configurar sua conta do Facebook Ads',
      duration: '8 min',
      type: 'video',
      thumbnail:
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-slate-600">Encontre respostas, tutoriais e suporte para o FLOWZZ</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl p-6 text-white">
          ...
          <p className="text-blue-100 text-sm mb-4">Fale com nossa equipe de suporte</p>
          <button
            type="button"
        ...
        <div className="bg-gradient-to-r from-green-500 to-green-600 rounded-xl p-6 text-white">
          ...
          <p className="text-green-100 text-sm mb-4">Envie sua dúvida por email</p>
          <button
            type="button"
        ...
        <div className="bg-gradient-to-r from-purple-500 to-purple-600 rounded-xl p-6 text-white">
          ...
          <p className="text-purple-100 text-sm mb-4">Ligue para (11) 4002-8922</p>
          <button
            type="button"
      ...
      {/* Tutorials Section */}
      <div>
        <h2 className="text-2xl font-bold text-slate-900 mb-6">Tutoriais e Guias</h2>
      ...
      <div className="bg-slate-100 rounded-xl p-6">
        <h2 className="text-xl font-bold text-slate-900 mb-4">Documentação Técnica</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex items-center space-x-3 p-4 bg-white rounded-lg hover:bg-slate-50 transition-colors cursor-pointer">
            ...
            <div>
              ...
              <p className="text-slate-600 text-sm">Guia completo da API do FLOWZZ</p>
            </div>
