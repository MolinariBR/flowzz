        ...
        <div className="text-center">
          {status === 'loading' && (
            <>
              ...
              <h1 className="text-xl font-semibold text-slate-900 mb-2">Conectando Facebook Ads</h1>
              <p className="text-slate-600">Aguarde enquanto processamos sua autenticação...</p>
            </>
          )}
          ...
          {status === 'success' && (
            <>
              ...
              <h1 className="text-xl font-semibold text-slate-900 mb-2">Conexão Bem-Sucedida!</h1>
          ...
          {status === 'error' && (
            <>
              ...
              <h1 className="text-xl font-semibold text-slate-900 mb-2">Erro na Conexão</h1>
              <p className="text-slate-600 mb-4">{message}</p>
      ...
      fallback={
        <div className="min-h-screen bg-slate-50 flex items-center justify-center">
          <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8">
            <div className="text-center">
              <Loader2 className="h-12 w-12 animate-spin text-blue-600 mx-auto mb-4" />
              <h1 className="text-xl font-semibold text-slate-900 mb-2">Carregando...</h1>
            </div>
          </div>
        </div>
      }
