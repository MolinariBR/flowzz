    ...
    <div className="space-y-6">
      ...
      >
            ...
            <tbody className="divide-y divide-slate-200">
              {clients.map((client) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <p className="font-mono font-semibold text-slate-900">R$ {client.value}</p>
                  </td>
                  <td className="px-6 py-4">
                    <div className="flex items-center space-x-2">
        ...
        <div className="px-6 py-4 border-t border-slate-200 flex items-center justify-between">
          <div className="text-sm text-slate-600">Mostrando 1 a 4 de 4 clientes</div>
          <div className="flex items-center space-x-2">
            <button
              type="button"
            ...
            <button type="button" className="px-3 py-1 bg-indigo-600 text-white rounded-lg text-sm">
              1
            </button>
            <button
              type="button"
